...
import net.ravendb.demo.view.editor.DoctorEditorDialog;
import net.ravendb.demo.model.Doctor;
import net.ravendb.demo.presenter.DoctorPresenter;
...
public class DoctorView extends VerticalLayout {
    ...
    private Component createHeader() {
        ...
        Button add = new Button("Add", e -> {
            DoctorEditorDialog d = new DoctorEditorDialog("Add", new Doctor(), this.presenter, () -> {
                load();
            });
        ...
        edit = new Button("Edit", e -> {
            DoctorEditorDialog d = new DoctorEditorDialog("Add",
                                   this.grid.asSingleSelect().getValue(), this.presenter, () -> {
                load();
            });
